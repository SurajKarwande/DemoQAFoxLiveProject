...
public class Login {
	...
	public void i_login_to_the_Applicatio_using_Username_and_Password(String email, String password) {
	...
	public void i_should_see_a_message_informing_the_User_that_information_related_to_reseting_password_have_been_sent_to_email_address(){
	  
		Assert.assertTrue(Elements.VerifyTextEquals(LoginPage.emailSentWarning, "An email with a confirmation link has been sent your email address."));
	}
